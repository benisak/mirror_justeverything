...
export const allRecipesByPaginationQuery = groq`
*[_type == "recipe" && (isHidden == false || isHidden == null) ] | order(publishedAt desc, _createdAt desc) [$pageIndex...$pageIndex + $limit] {
  _id,
  title,
  slug,
  excerpt,
...
*[_type == "recipe" && (isHidden == false || isHidden == null) && $categorySlug in categories[]->slug.current] {
  _id,
  title,
  slug,
  excerpt,
...
*[_type == "recipe" && featured == true && (isHidden == false || isHidden == null)] | order(publishedAt desc, _createdAt desc) [0..$limit] {
  _id,
  title,
  slug,
  excerpt,
...
*[_type == "recipe" && slug.current == $slug && (isHidden == false || isHidden == null)][0] {
  _id,
  title,
  slug,
  excerpt,
