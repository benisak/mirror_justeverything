export default {
  ...
  fields: [
          ...
          fields: [
            {
              ...
              type: "string",
              validation: Rule =>
                Rule.required().error("Ingredient title is required")
            },
            {
              name: "url",
              title: "URL",
    ...
    },
    {
      ...
      type: "array",
      of: [{ type: "string" }],
      description: "List of Amazon ASINs, here you can add an ASIN to search and add new products to the ingredients list for the recipe (optional)",
      ...
      fields: [
        {
          ...
          type: "blockContent",
          description: "Add detailed recommendations for this recipe"
        },
        {
          name: "recommendationUrl",
          title: "Recommendation URL",
          type: "url",
          description: "Add a relevant link for additional information"
        }
      ]
    },
