...
export default function Post({ post, loading }) {
  ...
  return (
    <>
          ...
          <div className="mx-auto w-full md:mx-0 md:w-auto lg:w-[616px]">
            ...
            <div className="flex w-full flex-col items-center px-0 md:items-start md:px-0">
              ...
              <div
                className={
                  (hasPostImage
                    ? "mt-6 md:mt-11 relative z-0 aspect-video"
                    : "mt-0 md:mt-0 relative z-0") +
                  " w-full overflow-hidden lg:rounded-lg"
                }
              >
                {hasPostImage && (
                  <Image
      ...
      <div className="mt-7 flex w-full flex-col items-start justify-center gap-6 bg-[#F6F6F6] px-4 py-6 lg:hidden">
